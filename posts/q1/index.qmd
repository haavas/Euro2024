---
title: "Spain is in the Semifinals"
...
The two strongest-looking teams in the tournament met, and there was little doubt as to who was strongest. Spain must surely be favorites to win the tournament now. 
...
```{r knock_45, echo = FALSE, warning=FALSE,  fig.height=10, fig.width=10}

invisible(Sys.setlocale())
poeng_prev <- tbl_df(read.csv("details44.csv", sep=";", header = FALSE, encoding = "utf-8"))
poeng_prev$total_prev <- poeng_prev$V2 + poeng_prev$V3 + poeng_prev$V4
poeng_prev <- poeng_prev %>% select(V1, total_prev)

poeng <- tbl_df(read.csv("details45.csv", sep=";", header = FALSE))
...
Few had any faith in Spain, but those how did are now rewarded. Vegard is now in third. 