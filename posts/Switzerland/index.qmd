...
# Switzerland beats Italy

Italy is out of the tournament, while Switzerland meet England or Slovakia in the next round. 
...
That was a surprise to everyone except Anna and Siri. Well done to you!

```{r knock_37, echo = FALSE, warning=FALSE,  fig.height=10, fig.width=10}

Sys.setlocale()
poeng_prev <- tbl_df(read.csv("details36.csv", sep=";", header = FALSE, encoding = "utf-8"))
poeng_prev$total_prev <- poeng_prev$V2 + poeng_prev$V3 + poeng_prev$V4
poeng_prev <- poeng_prev %>% select(V1, total_prev)

poeng <- tbl_df(read.csv("details37.csv", sep=";", header = FALSE))
